...
export default function AdminPanel() {
  ...
  const addProject = () => setDraft((current) => current.projects.length >= 6 ? current : ({ ...current, projects: [...current.projects, { number: String(current.projects.length + 1).padStart(2, "0"), name: "Новый проект", category: "Категория", description: "Коротко опишите задачу и результат проекта.", url: "", coverUrl: "", visual: "violet" }] }));
