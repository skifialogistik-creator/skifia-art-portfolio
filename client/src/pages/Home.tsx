...
function ProjectStackCard({ index, total, work, ui, previewSrc }: { index: number; total: number; work: SiteContent["projects"][number]; ui: ReturnType<typeof getUiCopy>; previewSrc?: string }) {
