...
import { ArrowDownRight, ArrowUpRight, Compass, ExternalLink, Menu, PanelsTopLeft, Rocket, X } from "lucide-react";
...
function StorefrontSiteCard({ work, index, onRequest }: { work: SiteContent["projects"][number]; index: number; onRequest: (work: SiteContent["projects"][number]) => void }) {
  ...
  const coverUrl = work.coverUrl || (index === 0 ? "/manus-storage/skifia-hero-real_8a891d4d.png" : "");
