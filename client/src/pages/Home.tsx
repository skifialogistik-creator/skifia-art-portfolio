...
function ServiceShowcase() {
  ...
  return <section id="services" className="services-showcase relative z-10 isolate min-h-screen overflow-hidden rounded-t-[42px] bg-white px-5 py-6 text-black sm:rounded-t-[60px] sm:px-8 sm:py-8 md:px-12">
    ...
    <div className="mx-auto flex min-h-[calc(100svh-3rem)] max-w-[1600px] flex-col sm:min-h-[calc(100svh-4rem)]">
      <div className="flex items-center justify-between gap-4"><motion.div {...fadeUp(0)} className="flex items-center gap-3"><span className="grid h-8 w-8 place-items-center rounded-full border-2 border-[#5e0ed7]"><i className="h-2.5 w-2.5 rounded-full bg-[#5e0ed7]" /></span><span className="font-mono text-[9px] font-semibold uppercase tracking-[.17em]">Услуги / 03</span></motion.div><motion.p {...fadeUp(0.1)} className="hidden font-mono text-[9px] font-semibold uppercase tracking-[.16em] md:block">Дизайн и разработка</motion.p><motion.a {...fadeUp(0.2)} href="#brief" className="rounded-full border border-black/15 bg-white/60 px-4 py-2 font-mono text-[9px] font-semibold uppercase tracking-[.14em] backdrop-blur-sm transition-colors hover:bg-[#5e0ed7] hover:text-white">Начать проект <ArrowUpRight className="ml-1 inline h-3.5 w-3.5" /></motion.a></div>
