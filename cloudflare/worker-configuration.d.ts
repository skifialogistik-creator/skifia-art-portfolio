/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc cloudflare/worker-configuration.d.ts` (hash: fa35627d395a45bfd10117e744df7af0)
// Runtime types generated with workerd@1.20260820.1 2026-08-25 
interface __BaseEnv_Env {
	MEDIA: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	OWNER_EMAIL: "skifia.logistik@gmail.com";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OWNER_EMAIL" | "ACCESS_TEAM_DOMAIN" | "ACCESS_POLICY_AUD">> {}
}
