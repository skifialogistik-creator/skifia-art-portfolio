...
try {
  ...
  await wait(700);
  await evaluate("window.scrollTo(0, 0); ({ width: innerWidth, height: innerHeight })");
  ...
  console.log(JSON.stringify({ viewport: { width: 390, height: 844 }, sequence: sequenceResults }, null, 2));
} finally {
