...
export const localeOrder = ["uk", "pl", "ru"] as const;
...
export function normalizeSiteContentBundle(value: SiteContent | SiteContentBundle | unknown): SiteContentBundle {
  if (isSiteContentBundle(value)) {
    ...
    return {
      defaultLocale: raw.defaultLocale && isLocale(raw.defaultLocale) ? raw.defaultLocale : "uk",
      locales: {
